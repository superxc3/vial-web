...
class MainWindow(QMainWindow):
    ...
    def __init__(self, appctx):
        ...
        self.editors = [(self.keymap_editor, "Keymap"), (self.layout_editor, "Layout"), (self.macro_recorder, "Macros"),
                        ...
                        (self.updates, "Updates"), (self.firmware_flasher, "Firmware updater")]
    ...
    def rebuild(self):
        ...
        for e in [self.layout_editor, self.keymap_editor, self.firmware_flasher, self.macro_recorder,
                  ...
                  self.trackpad_configurator, self.oled_configurator, self.updates]:
    ...
    def refresh_tabs(self):
        ...
        for container, lbl in self.editors:
            ...
            # an editor may decorate its own title, e.g. "Updates (beta) *" when an update exists
            title = container.tab_title() if hasattr(container, "tab_title") else tr("MainWindow", lbl)
